...
if (isset($_POST['Submit'])){
    ...
    $sql="INSERT INTO article(Author,Title, Description) VALUES('$Author','$Title','$Description')";
...
<h1>Article Posting<span>*Please fill all the texts in the fields.</span></h1>
<p><label><span>Name* :</span><input id="name" type="text" name="Author" placeholder="Your Full Name"></label>
<label><span>Title* :</span><input id="email" type="text" name="Title" placeholder="Title of Article"></label>
<label><span>Description* :</span><textarea id="message" name="Description" placeholder="Your Message about heading"></textarea></label>
